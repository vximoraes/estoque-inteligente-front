'use client';
import CardItemConsumo from '@/app/(auth)/bens/almoxarifado/_components/card-item-consumo';
import Cabecalho from '@/components/layout/cabecalho';
import ModalLocalizacoes from '@/app/(auth)/bens/almoxarifado/_components/modal-localizacoes';
import ModalFiltros from '@/components/comum/modal-filtros';
import ModalEntradaItem from '@/app/(auth)/bens/almoxarifado/_components/modal-entrada-item';
import ModalSaidaItem from '@/app/(auth)/bens/almoxarifado/_components/modal-saida-item';
import ModalEmprestarItem from '@/app/(auth)/bens/almoxarifado/_components/modal-emprestar-item';
import ModalExcluirItem from '@/app/(auth)/bens/almoxarifado/_components/modal-excluir-item';
import ModalCadastrarItemConsumo from '@/app/(auth)/bens/almoxarifado/_components/modal-cadastrar-item-consumo';
import ModalEditarItem from '@/app/(auth)/bens/almoxarifado/_components/modal-editar-item';
import ItemConsumoLinhaAcoes from '@/app/(auth)/bens/almoxarifado/_components/item-consumo-linha-acoes';
