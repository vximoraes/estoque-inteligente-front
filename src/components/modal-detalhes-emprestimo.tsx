...
export default function ModalDetalhesEmprestimo({
  ...
  const modalContent = (
    ...
    >
      <div
        className="bg-card rounded-sm border border-border max-w-2xl w-full max-h-[85vh] flex flex-col overflow-hidden animate-in fade-in-0 zoom-in-95 duration-300"
